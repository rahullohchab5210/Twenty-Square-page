  ...
  return (
    <div className="flex items-start justify-center px-6 pt-39.25 max-[1170px]:pt-25">
      <div className="flex flex-col items-center text-center">
        <h1 className="font-semibold lg:max-w-182 max-w-150 text-5xl sm:text-6xl lg:text-7xl leading-[121%] tracking-normal bg-linear-to-r from-[#000000] to-[#494949] bg-clip-text text-transparent">
