...
function Footer() {
  return (
    <div className='bg-[#F2F2F2]  mt-[101px] '>
      <div className='max-w-[1298px] mx-auto px-4'>
        <div className='flex lg:flex-row flex-col max-lg:gap-y-10 justify-between w-full pt-[38px] pb-[59px]'>
          ...
          <div className=' shadow-[-33px_37px_43.8px_-17px_rgba(0,0,0,0.10)] bg-white max-w-[330px] rounded-[16px] pb-[18.38px] pt-[6.62px] pl-[17.89px] w-full -rotate-[3.5deg] '>
        ...
        <div className='flex flex-col sm:gap-12.75 gap-10 mb-[51px]'>
...
// function Footer() {
//   return (
//     <div className='bg-[#F2F2F2]  mt-[220px] max-[1200px]:mt-[800px] max-[850px]:mt-[1000px] max-md:mt-0 max-sm:mt-15'>
//       <div className='max-w-[1298px] mx-auto px-4'>
//         <div className='flex lg:flex-row flex-col max-lg:gap-y-10 justify-between w-full pt-[38px] pb-[59px]'>
//           <div className='flex sm:flex-row flex-col lg:gap-[175.14px] max-lg:justify-between max-sm:gap-y-10 w-full'>
//             <a href="#">
